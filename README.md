...
2. Create and activate a Conda environment named `rush-tools` with the required packages:
   ...
   conda create -n rush-tools -c conda-forge python=3.11 cupy numba pandas h5netcdf rasterio pyproj xarray dataretrieval cfgrib spotpy boto3 zarr cuda-version=12.6 -y
